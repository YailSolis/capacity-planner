...
if clean.isdigit(): # Input must prove it's a number before passing; otherwise the program crashes with a ValueError
    ...
    # this 2nd input exists after you give a number to the first input if its not a number then this line never runs
        ...
        if clean.isdigit() and int(clean) > 0 : # this is the 2nd gate if and its like a toll road pay befor you go 
            ...
            print("a server cant be 0gb, the server must be between 1gb and 24000gb") # this is the first else if you type anything but a number 
else:
    print("this is not gonna work here pal")
